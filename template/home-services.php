<section class="home-services section">
    ...
    <div class="wrap">
        ...
        <h3 class="section-title"><?php echo get_field( 'services_title' ); ?></h3>
        <div class="section-subtitle"><?php echo the_field( 'services_subtitle' ); ?></div>
        ...
        <div class="services-wrap">
            ...
            <?php if( have_rows( 'services_section_list' ) ): ?>
